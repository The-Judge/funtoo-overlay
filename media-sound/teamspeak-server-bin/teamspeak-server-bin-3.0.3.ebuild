...
# $Header:
# /var/cvsroot/gentoo-x86/media-sound/teamspeak-server-bin/teamspeak-server-bin-3.0.1.ebuild,v1.0 2012/01/03 00:00:21 peratu Exp $
...
SRC_URI="
	amd64? ( http://teamspeak.gameserver.gamed.de/ts3/releases/3.0.3/teamspeak3-server_linux-amd64-${PV/_/-}.tar.gz )
	x86? ( http://teamspeak.gameserver.gamed.de/ts3/releases/3.0.3/teamspeak3-server_linux-x86-${PV/_/-}.tar.gz )"
