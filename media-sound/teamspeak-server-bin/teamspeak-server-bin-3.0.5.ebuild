...
SRC_URI="
	amd64? ( http://teamspeak.gameserver.gamed.de/ts3/releases/3.0.5/teamspeak3-server_linux-amd64-${PV/_/-}.tar.gz )
	x86? ( http://teamspeak.gameserver.gamed.de/ts3/releases/3.0.5/teamspeak3-server_linux-x86-${PV/_/-}.tar.gz )"
